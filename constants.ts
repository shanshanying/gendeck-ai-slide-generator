...
export const TRANSLATIONS = {
  en: {
    ...
    sourceModeDocument: "Raw Content",
    sourceModeMarkdownOutline: "Markdown Outline",
    sourcePlaceholder: "Paste text or upload .txt/.md",
    pastePlaceholder: "Paste your document content here...",
    markdownOutlinePlaceholder: "Paste markdown outline with sections like: ## Slide 1 — Cover",
    markdownOutlineHint: "Markdown outline mode skips AI outline generation and directly renders HTML slides from your outline.",
    markdownDirectFlow: "Markdown direct flow: 1) Paste full outline with metadata, 2) Parse and render HTML directly, 3) Download HTML deck.",
    parsingMarkdownOutline: "Parsing markdown outline...",
    generatingHtmlDeck: "Generating HTML deck...",
    uploadFile: "Upload File",
    generateBtn: "Generate Outline (Step 1/3)",
    generateFromMarkdownBtn: "Parse Outline & Continue",
    thinking: "Thinking...",
    ...
    stageInput: "1. Input",
    stageOutline: "2. Outline",
    stageRender: "3. Render HTML",
    stageExport: "4. Download HTML",
    stageOutlineGenerating: "Stage 1/2: Outline",
    stageOutlineGeneratingHint: "Analyzing content and structuring slides",
    stageOutlineReview: "Stage 1/2: Review",
    stageOutlineReviewHint: "Refine the outline before rendering slides",
    stageRenderLabel: "Stage 2/2: Rendering",
    stageRenderHint: "You can pause, resume, or cancel generation",
    stageCompleteReady: "Complete: Ready to export",
    stageCompleteReadyHint: "Preview once, then download HTML deck",
    stageCompleteWithFailed: "Complete with failed slides",
    stageCompleteWithFailedHint: "Retry failed slides before export.",
    recoveredProject: "Recovered your last in-progress project.",
    dismiss: "Dismiss",
    failedSlidesBanner: "slides failed to render. Retry before export.",
    retryFailedSlides: "Retry Failed Slides",
    generatingNotes: "Generating speaker notes...",
    collapseSlideChat: "Collapse slide chat",
    expandSlideChat: "Expand slide chat",
    slideUpdateChat: "Slide Update Chat",
    currentSlide: "Current slide",
    selectSlide: "Select a slide",
    slideChatEmptyHint: "Describe the change, e.g. \"Make this slide a concise 3-point structure.\"",
    you: "You",
    assistant: "Assistant",
    bulkGenerationHint: "Bulk generation in progress. Pause to update a single slide via chat.",
    slideChatPlaceholder: "Describe how to update the selected slide...",
    sendAndUpdateSlide: "Send & Update Slide",
    updatingShort: "Updating...",
    preExportCheck: "Pre-export Check",
    targetFormatHtml: "Target format: HTML",
    resolveBlockingIssues: "Resolve blocking issues first",
    exportAnyway: "Export anyway",
    confirmNewBody: "All progress on the current presentation will be cleared, including generated slides and settings. This action cannot be undone.",
    confirmNewBtn: "Confirm New",
    invalidProjectFile: "Invalid project file. Could not open.",
    noRenderedSlides: "No rendered slides to preview yet. Generate slides first.",
    previewBlocked: "Preview window was blocked by the browser. Please allow pop-ups and try again.",
    outlineGenerateFailed: "Failed to generate outline. Please check your settings, API Key, or text content.",
    notesCountMismatch: "Generated note count didn't match slide count. Some notes might be missing.",
    notesGenerateFailed: "Failed to generate notes. Please try again.",
    slideRegenerateFailed: "Slide regeneration failed",
    slideUpdatedByRequest: "Updated the selected slide based on your request.",
    slideUpdateFailed: "Update failed. Please refine your request and try again.",
    quickMode: "Quick",
    advancedMode: "Advanced",
    customModelPlaceholder: "e.g. qwen2.5:14b or gpt-4o-mini",
    apiKeyRequired: "API key is required for the selected provider.",
    hideAdvancedOptions: "Hide advanced options",
    advancedOptions: "Advanced options",
    baseUrl: "Base URL",
    notRequiredForGoogle: "Not required for Google",
    enterApiBaseUrl: "Enter API Base URL",
    effectiveValue: "Effective value",
    notSet: "Not set",
    quickModeFlow: "Quick mode flow: 1) Generate outline, 2) Review outline/layout, 3) Render and download HTML deck.",
    aiAutoAnalysis: "AI Auto Analysis",
    aiAutoAnalysisDesc: "Analyze content to recommend audience and purpose",
    targetAudience: "Target Audience",
    customAudience: "Custom Audience",
    enterCustomAudience: "Enter custom audience...",
    category: "Category",
    specificAudience: "Specific Audience",
    current: "Current:",
    presentationPurpose: "Presentation Purpose",
    customPurpose: "Custom Purpose",
    enterCustomPurpose: "Enter custom purpose...",
    specificPurpose: "Specific Purpose",
    strictMode: "Strict Mode",
    errEnterContentAnalyze: "Please enter content to analyze",
    errMissingApiKey: "Missing API Key for",
    errSetModelId: "Please set a model ID.",
    errSetBaseUrl: "Please set a Base URL.",
    errSelectAudience: "Please select or enter target audience",
    errSelectPurpose: "Please select or enter presentation purpose",
    errMarkdownOutlineFormat: "Markdown outline mode requires headings like: ## Slide 1 — Cover",
    untitledPresentation: "Untitled Presentation",
    analysisFailedTryAgain: "Analysis failed, please try again",
    markdownOutlineParseFailed: "Failed to parse markdown outline. Please check slide heading format.",
    outlineQualityCheck: "Outline Quality Check",
    outlineQualityDesc: "Validate structure before rendering your downloadable HTML deck.",
    ready: "Ready",
    needsFixes: "Needs Fixes",
    errors: "Errors",
    warnings: "Warnings",
    checksPassed: "Checks passed: ready for HTML slide generation.",
    autoFixRequiredFields: "Auto-fix Required Fields",
    normalizeLayoutLabels: "Normalize Layout Labels",
    moveUp: "Move Up",
    moveDown: "Move Down",
    delete: "Delete",
    coverStyleModern: "Modern Left",
    coverStyleElegant: "Elegant Serif",
    coverStyleBold: "Big & Bold",
    endingStyleMinimal: "Minimal",
    endingStyleContact: "Contact Info",
    endingStyleBrand: "Brand Focus",
    ...
    collapse: "Collapse",
    expand: "Expand",
    recommendedForDeck: "Recommended for this deck",
    safeDefaults: "Safe defaults",
    htmlCode: "HTML Code",
    themeCategoryBusiness: "Business",
    themeCategoryGovernment: "Government",
    themeCategoryTech: "Tech Internet",
    themeCategoryMinimalist: "Minimalist",
    themeCategoryArtistic: "Artistic",
    themeCategoryFeminine: "Feminine Power",
  },
  zh: {
    appTitle: "GenDeck",
    estCost: "预计成本",
    ...
    generatingOutline: "正在生成大纲（第 1/3 步）...",
    presentationReady: "演示已就绪",
    generateNotes: "生成备注",
    regenerateNotes: "重新生成备注",
    preview: "预览演示",
    downloadHtml: "下载 HTML 演示",
    otherFormats: "更多导出选项",
    exportOutline: "大纲（Markdown）",
    exportNotes: "演讲备注（Txt）",
    new: "新建",
    confirmNew: "确定吗？所有进度将丢失。",
    createNewDeck: "创建新演示",
    modelSettings: "模型设置",
    apiCredentials: "API 凭据",
    step1Outline: "步骤 1：生成大纲",
    step2Slides: "步骤 2：渲染 HTML 幻灯片",
    aiModel: "AI 模型",
    provider: "提供商",
    model: "模型",
    topicLabel: "主题 / 标题",
    topicPlaceholder: "例如：Q3 业务复盘",
    ...
    sourceLabel: "源文档",
    sourceModeDocument: "原始内容",
    sourceModeMarkdownOutline: "Markdown 大纲",
    sourcePlaceholder: "粘贴文本或上传 .txt/.md",
    pastePlaceholder: "在此粘贴文档内容...",
    markdownOutlinePlaceholder: "粘贴 Markdown 大纲，使用类似：## Slide 1 — Cover",
    markdownOutlineHint: "Markdown 大纲模式会跳过 AI 大纲生成，直接根据大纲渲染 HTML 幻灯片。",
    markdownDirectFlow: "Markdown 直出流程：1）粘贴完整大纲（含元信息），2）解析后直接渲染 HTML，3）下载 HTML 演示。",
    parsingMarkdownOutline: "正在解析 Markdown 大纲...",
    generatingHtmlDeck: "正在生成 HTML 演示...",
    uploadFile: "上传文件",
    generateBtn: "生成大纲（第 1/3 步）",
    generateFromMarkdownBtn: "解析大纲并继续",
    thinking: "思考中...",
    googleApiKeyNote: "通过系统环境变量管理",
    cancel: "取消",
    feelingLuckyTitle: "AI 自动分析",
    feelingLuckyDesc: "让 AI 分析内容并推荐受众与目标",
    feelingLuckyBtn: "试试手气",
    analyzing: "分析中...",
    analysisResult: "AI 分析结果：",
    emptyContentError: "请输入要分析的内容",
    analysisError: "内容分析失败，请重试。",
    reviewStyle: "审阅大纲（第 2/3 步）",
    refineStructure: "优化幻灯片结构和布局，然后渲染 HTML 演示。",
    back: "返回",
    generateSlidesBtn: "渲染 HTML 演示（第 3/3 步）",
    selectPalette: "选择配色",
    customPalette: "自定义配色：",
    colorPreview: "预览",
    colorBg: "背景",
    ...
    addNewSlide: "新增幻灯片",
    subtitle: "副标题",
    subtitlePlaceholder: "演示副标题或摘要...",
    titleStyle: "标题样式",
    visualNotes: "视觉 / 布局说明",
    visualNotesPlaceholder: "给 AI 设计师的说明...",
    closingMessage: "结尾信息",
    closingPlaceholder: "感谢聆听...",
    endingStyle: "结束页样式",
    contentPoints: "内容要点",
    ...
    themeSelectionHintDesc: "生成幻灯片后，可在演示预览中更改配色主题",
    paletteHint: "点击任意主题可立即在当前幻灯片预览",
    livePreview: "配色预览",
    cBg: "BG",
    cBgSoft: "SOFT",
    cBgGlass: "GLASS",
    ...
    cInfo: "INFO",
    slidesHeader: "幻灯片",
    noSlides: "暂无幻灯片。请先配置并生成。",
    noSlideSelected: "未选择幻灯片",
    selectSlidePrompt: "请在侧边栏选择幻灯片进行预览、重生成或编辑。",
    updating: "更新中...",
    zoomOut: "缩小",
    zoomIn: "放大",
    fitToScreen: "适应屏幕",
    ...
    close: "关闭",
    instructions: "重生成说明",
    instructionPlaceholder: "例如：改为两项对比布局...",
    apply: "应用",
    overwriteConfirm: "覆盖当前幻灯片设计？",
    yesRegenerate: "是，重新生成",
    constraints: "当前系统约束",
    regeneratingSlide: "正在重新生成幻灯片...",
    generatingDesign: "正在生成幻灯片设计...",
    waitingGeneration: "等待生成中...",
    checkSidebar: "请查看侧边栏或点击重新生成",
    speakerNotes: "演讲备注",
    noNotes: "暂无备注。请在大纲视图或导出菜单中点击“生成备注”。",
    pause: "暂停",
    resume: "继续",
    language: "语言",
    langEnglish: "EN",
    ...
    stageInput: "1. 输入",
    stageOutline: "2. 大纲",
    stageRender: "3. 渲染 HTML",
    stageExport: "4. 下载 HTML",
    stageOutlineGenerating: "阶段 1/2：生成大纲",
    stageOutlineGeneratingHint: "正在分析内容并组织幻灯片结构",
    stageOutlineReview: "阶段 1/2：审阅",
    stageOutlineReviewHint: "渲染前先优化大纲",
    stageRenderLabel: "阶段 2/2：渲染中",
    stageRenderHint: "可暂停、继续或取消生成",
    stageCompleteReady: "完成：可导出",
    stageCompleteReadyHint: "先预览，再下载 HTML 演示",
    stageCompleteWithFailed: "完成但有失败页",
    stageCompleteWithFailedHint: "导出前请先重试失败页。",
    recoveredProject: "已恢复你上次未完成的项目。",
    dismiss: "关闭",
    failedSlidesBanner: "页渲染失败。请在导出前重试。",
    retryFailedSlides: "重试失败页",
    generatingNotes: "正在生成演讲备注...",
    collapseSlideChat: "收起单页对话",
    expandSlideChat: "展开单页对话",
    slideUpdateChat: "单页更新对话",
    currentSlide: "当前幻灯片",
    selectSlide: "请选择一页",
    slideChatEmptyHint: "描述你想修改的内容，例如“改成精简 3 点结构”。",
    you: "你",
    assistant: "助手",
    bulkGenerationHint: "批量生成进行中。请先暂停后再通过对话更新单页。",
    slideChatPlaceholder: "描述如何更新所选幻灯片...",
    sendAndUpdateSlide: "发送并更新幻灯片",
    updatingShort: "更新中...",
    preExportCheck: "导出前检查",
    targetFormatHtml: "目标格式：HTML",
    resolveBlockingIssues: "请先处理阻塞问题",
    exportAnyway: "仍然导出",
    confirmNewBody: "当前演示的所有进度都会被清除，包括已生成幻灯片和设置。该操作无法撤销。",
    confirmNewBtn: "确认新建",
    invalidProjectFile: "项目文件无效，无法打开。",
    noRenderedSlides: "暂无可预览的已渲染幻灯片。请先生成。",
    previewBlocked: "浏览器拦截了预览窗口。请允许弹窗后重试。",
    outlineGenerateFailed: "生成大纲失败。请检查设置、API Key 或文本内容。",
    notesCountMismatch: "生成的备注数量与幻灯片数量不一致，部分备注可能缺失。",
    notesGenerateFailed: "生成备注失败，请重试。",
    slideRegenerateFailed: "单页重新生成失败",
    slideUpdatedByRequest: "已按你的要求更新当前幻灯片。",
    slideUpdateFailed: "更新失败。请调整指令后重试。",
    quickMode: "快速模式",
    advancedMode: "高级模式",
    customModelPlaceholder: "例如：qwen2.5:14b 或 gpt-4o-mini",
    apiKeyRequired: "当前提供商必须填写 API Key。",
    hideAdvancedOptions: "隐藏高级选项",
    advancedOptions: "高级选项",
    baseUrl: "Base URL",
    notRequiredForGoogle: "Google 无需填写",
    enterApiBaseUrl: "请输入 API Base URL",
    effectiveValue: "生效值",
    notSet: "未设置",
    quickModeFlow: "快速模式流程：1）生成大纲，2）审阅大纲/布局，3）渲染并下载 HTML 演示。",
    aiAutoAnalysis: "AI 自动分析",
    aiAutoAnalysisDesc: "分析内容并推荐受众与目标",
    targetAudience: "目标受众",
    customAudience: "自定义受众",
    enterCustomAudience: "输入自定义受众...",
    category: "分类",
    specificAudience: "具体受众",
    current: "当前：",
    presentationPurpose: "演示目的",
    customPurpose: "自定义目的",
    enterCustomPurpose: "输入自定义目的...",
    specificPurpose: "具体目的",
    strictMode: "严格模式",
    errEnterContentAnalyze: "请输入需要分析的内容",
    errMissingApiKey: "缺少 API Key：",
    errSetModelId: "请设置模型 ID。",
    errSetBaseUrl: "请设置 Base URL。",
    errSelectAudience: "请选择或输入目标受众",
    errSelectPurpose: "请选择或输入演示目的",
    errMarkdownOutlineFormat: "Markdown 大纲模式需要使用类似：## Slide 1 — Cover 的标题格式",
    untitledPresentation: "未命名演示",
    analysisFailedTryAgain: "分析失败，请重试",
    markdownOutlineParseFailed: "Markdown 大纲解析失败，请检查幻灯片标题格式。",
    outlineQualityCheck: "大纲质量检查",
    outlineQualityDesc: "在渲染可下载 HTML 演示前，先校验结构。",
    ready: "就绪",
    needsFixes: "需修复",
    errors: "错误",
    warnings: "警告",
    checksPassed: "检查通过：可开始生成 HTML 幻灯片。",
    autoFixRequiredFields: "自动修复必填项",
    normalizeLayoutLabels: "规范布局标签",
    moveUp: "上移",
    moveDown: "下移",
    delete: "删除",
    coverStyleModern: "现代左对齐",
    coverStyleElegant: "优雅衬线",
    coverStyleBold: "大字强调",
    endingStyleMinimal: "极简",
    endingStyleContact: "联系方式",
    endingStyleBrand: "品牌聚焦",
    layoutStandard: "标准",
    layoutCompare: "对比",
    layoutGrid: "网格",
    layoutTimeline: "时间线",
    ...
    collapse: "收起",
    expand: "展开",
    recommendedForDeck: "本演示推荐",
    safeDefaults: "安全默认",
    htmlCode: "HTML 代码",
    themeCategoryBusiness: "商务",
    themeCategoryGovernment: "政企",
    themeCategoryTech: "科技互联网",
    themeCategoryMinimalist: "极简",
    themeCategoryArtistic: "艺术",
    themeCategoryFeminine: "女性力量",
  },
};
